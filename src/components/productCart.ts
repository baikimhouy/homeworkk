export function productCard(product: any): string {
  return `
...
// src/components/productCart.ts
import { formatCategoryName } from './productService';

export function renderProducts(container: HTMLElement, products: any[]) {
