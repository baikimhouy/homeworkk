...
function fetchProducts() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const res = yield fetch("https://dummyjson.com/products?limit=52");
...
function renderProducts(productsToRender) {
 ...
 class="group relative block overflow-hidden rounded-2xl bg-gray-50 shadow-md transition hover:shadow-lg">
        ...
        <img src="${product.thumbnail}" alt="${product.title}" class="h-64 w-full object-cover transition duration-500 group-hover:scale-105 sm:h-72" />
        <div class="relative border border-gray-100 bg-white p-6">
          ...
          <div class="text-sm text-gray-500 mt-1">${formatCategoryName(product.category)}</div>
